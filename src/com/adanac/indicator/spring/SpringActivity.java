package com.adanac.indicator.spring;
...
import com.adanac.view.indicator.IndicatorViewPager.IndicatorPagerAdapter;
import com.adanac.view.indicator.IndicatorViewPager.IndicatorViewPagerAdapter;
import com.adanac.view.indicator.slidebar.SpringBar;
...
public class SpringActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		indicator.setOnTransitionListener(new OnTransitionTextListener()
				.setColor(selectColorId, unSelectColorId));
		indicator.setScrollBar(new SpringBar(getApplicationContext(),
				Color.GRAY));
	...
	private IndicatorPagerAdapter adapter = new IndicatorViewPagerAdapter() {
		...
		public View getViewForTab(int position, View convertView,
				ViewGroup container) {
			if (convertView == null) {
				convertView = inflate.inflate(R.layout.tab_top2, container,
						false);
			}
		...
		public View getViewForPage(int position, View convertView,
				ViewGroup container) {
			if (convertView == null) {
				convertView = inflate.inflate(R.layout.fragment_tabmain_item,
						container, false);
			}
			final TextView textView = (TextView) convertView
					.findViewById(R.id.fragment_mainTab_item_textView);
